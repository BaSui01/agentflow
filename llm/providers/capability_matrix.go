...
var ChatProviderCapabilityMatrix = []ProviderCapability{
	...
	{Provider: "Gemini", Image: true, Video: true, AudioGenerate: true, AudioSTT: false, Embedding: true, FineTuning: false},
	{Provider: "DeepSeek", Image: false, Video: false, AudioGenerate: false, AudioSTT: false, Embedding: false, FineTuning: false},
	{Provider: "Qwen", Image: true, Video: false, AudioGenerate: true, AudioSTT: false, Embedding: true, FineTuning: false},
	{Provider: "GLM", Image: true, Video: true, AudioGenerate: false, AudioSTT: false, Embedding: true, FineTuning: false},
	{Provider: "Grok", Image: true, Video: false, AudioGenerate: false, AudioSTT: false, Embedding: true, FineTuning: false},
	...
	{Provider: "Mistral", Image: false, Video: false, AudioGenerate: false, AudioSTT: true, Embedding: true, FineTuning: false},
