...
为 agentflow 框架的所有 13 个 LLM Provider 实现完整的多模态能力支持，包括：
- 🖼️ 图像生成
- 🎬 视频生成
- 🎵 音频生成
- 🎤 音频转录
...
本次实现为 agentflow 框架添加了完整的多模态支持，覆盖了所有 13 个 LLM Provider。通过统一的接口设计和灵活的实现策略，使得框架能够轻松支持图像生成、视频生成、音频生成、音频转录、Embedding 和微调等功能。
