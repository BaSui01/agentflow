...
type OpenAIProvider struct {
	*providerbase.BaseCapabilityProvider
}
...
func NewOpenAIProvider(cfg OpenAIConfig) *OpenAIProvider {
	...
	return &OpenAIProvider{
		BaseCapabilityProvider: providerbase.NewBaseCapabilityProvider(providerbase.CapabilityConfig{
...
func (p *OpenAIProvider) Moderate(ctx context.Context, req *ModerationRequest) (*ModerationResponse, error) {
	...
	model := providerbase.ChooseCapabilityModel(req.Model, p.Model)
	...
	out := &ModerationResponse{
		Provider:  p.Name(),
		Model:     providerbase.ChooseCapabilityModel(resp.Model, model),
