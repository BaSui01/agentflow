...
// buildValidationFeedbackMessage creates retry guidance from validation errors.
...
// Observe processes external feedback and persists it into the configured memory layer.
