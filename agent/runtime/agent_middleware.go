...
// memoryLoadMiddleware loads working and short-term memory into the execution context.
...
// promptEnhancerMiddleware enhances the user prompt with skill and memory context.
