...
- `internal/app/bootstrap/protocol_runtime_builder.go`
  - protocol server runtime setup (MCP/A2A)
- `internal/app/bootstrap/workflow_runtime_builder.go`
...
- `internal/app/bootstrap/rag_handler_runtime_builder.go`
  - RAG runtime setup (embedding provider + vector store)
- `internal/app/bootstrap/tool_approval_runtime_handlers.go`
  - tool approval runtime and audit history runtime implementations
...
- `internal/app/bootstrap/workflow_checkpoint_store_builder.go`
  - Workflow checkpoint store wiring (MongoDB-backed)
- `internal/app/bootstrap/agent_checkpoint_store_builder.go`
  - Agent checkpoint store wiring (MongoDB-backed)
