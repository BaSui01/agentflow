...
`agent/collaboration/team` is the official multi-agent facade in AgentFlow. New integrations should start here:
...
## Legacy Hierarchical Agent (Supervisor-Worker)
...
1. Prefer `agent/collaboration/team` for new multi-agent integrations
