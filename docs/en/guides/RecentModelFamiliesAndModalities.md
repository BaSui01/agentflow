...
|---|---|---|---|---|
| OpenAI GPT-5 | `gpt-5.4`, `gpt-5.4-pro`, `gpt-5.4-mini` | `llm/providers/openai` | Prefer Responses API; `reasoning.effort`, `text.verbosity`, `previous_response_id`, `conversation_id`, `phase`, and `tool_choice.allowed_tools` matter more than legacy sampling knobs. `gpt-5.5` is already in ChatGPT / Codex, but API availability is still marked as coming soon | [Latest model guide](https://developers.openai.com/api/docs/guides/latest-model), [All models](https://developers.openai.com/api/docs/models/all-models), [Responses create](https://developers.openai.com/api/reference/resources/responses/methods/create) |
| Anthropic Claude 4 | `claude-opus-4-7`, `claude-sonnet-4-6`, `claude-haiku-4-5` | `llm/providers/anthropic` | `system` is separate; thinking/output config differs from OpenAI; Opus 4.7 prefers adaptive thinking; Models API exposes `capabilities`, `max_input_tokens`, and `max_tokens` | [Models overview](https://platform.claude.com/docs/en/about-claude/models/overview), [Messages API](https://platform.claude.com/docs/en/api/messages), [Extended thinking](https://platform.claude.com/docs/en/docs/build-with-claude/extended-thinking), [List models](https://platform.claude.com/docs/en/api/models/list) |
| Google Gemini 3 / 2.5 | `gemini-3.1-pro-preview`, `gemini-3.1-flash-preview`, `gemini-2.5-pro`, `gemini-2.5-flash` | `llm/providers/gemini` | Gemini 3.x uses `thinkingLevel`; Gemini 2.5 uses `thinkingBudget`; structured output uses `responseMimeType` + `responseJsonSchema`; `includeThoughts` and `usageMetadata.thoughtsTokenCount` matter for reasoning-aware flows | [Models](https://ai.google.dev/gemini-api/docs/models), [Thinking](https://ai.google.dev/gemini-api/docs/thinking), [GenerationConfig](https://ai.google.dev/api/rest/v1beta/GenerationConfig), [GenerateContent](https://ai.google.dev/api/generate-content) |
| DeepSeek | `deepseek-v4-pro`, `deepseek-v4-flash`, `deepseek-chat`, `deepseek-reasoner` | `llm/providers/vendor` + `openaicompat` | As of 2026-04-24, official docs promote V4-Pro / V4-Flash. `deepseek-chat` and `deepseek-reasoner` still work today, but official docs mark them for retirement on 2026-07-24 | [Updates](https://api-docs.deepseek.com/updates/), [Reasoning model](https://api-docs.deepseek.com/guides/reasoning_model), [Chat completion](https://api-docs.deepseek.com/api/create-chat-completion) |
...
| xAI Grok | `grok-4.20`, `grok-4.20-multi-agent-0309`, `grok-4-1-fast-reasoning` | `llm/providers/vendor` + `openaicompat` | Official docs recommend `grok-4.20` by default. `reasoning.effort` only applies to the multi-agent model, while the current AgentFlow compat reasoning route still maps to `grok-4.20-reasoning` and rejects unsupported sampling fields locally | [Models](https://docs.x.ai/docs/models/), [Reasoning](https://docs.x.ai/developers/model-capabilities/text/reasoning) |
