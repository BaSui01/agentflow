...
---
## P1-4: Browser Automation 实现（已归档）

该任务对应的 browser 能力已在治理重构中明确决策为“放弃集成并整组删除”。

- 删除范围：`agent/browser/*`、`agent/hosted/browser.go`、bootstrap 中 `browser_automation` 注册链路
- 文档与示例已同步清理（README/教程/示例）
