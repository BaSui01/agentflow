...
- [x] 2. Implement xAI Grok Provider (OpenAI-compatible)
  ...
  - [x] 2.5 Write property test for default BaseURL configuration
    - **Property 1: Default BaseURL Configuration**
    - **Validates: Requirements 1.2**
  
  - [x] 2.6 Write property test for Bearer Token authentication
    - **Property 2: Bearer Token Authentication**
    - **Validates: Requirements 1.3**
  
  - [x] 2.7 Write property test for model selection priority
    - **Property 5: Default Model Selection Priority**
    - **Validates: Requirements 1.7, 14.1, 14.2, 14.3**

- [x] 3. Implement Alibaba Qwen Provider (OpenAI-compatible)
  - [x] 3.1 Create providers/qwen/provider.go with QwenProvider struct
  ...
  - [x] 3.2 Implement Provider interface methods
  ...
  - [x] 3.3 Write property test for OpenAI format conversion
    - **Property 3: OpenAI Format Conversion for Compatible Providers**
    - **Validates: Requirements 4.4**

- [x] 4. Implement DeepSeek Provider (OpenAI-compatible)
  - [x] 4.1 Create providers/deepseek/provider.go with DeepSeekProvider struct
    - Implement NewDeepSeekProvider constructor with default BaseURL "https://api.deepseek.com"
    - Initialize HTTP client and RewriterChain
    - _Requirements: 5.1, 5.2_
  
  - [x] 4.2 Implement Provider interface methods
  ...
  - [x] 4.3 Write property test for credential override
    - **Property 6: Credential Override from Context**
    - **Validates: Requirements 5.8**

- [x] 5. Checkpoint - Verify OpenAI-compatible providers work
  - Ensure all tests pass for Grok, Qwen, and DeepSeek providers
  - Ask the user if questions arise

- [x] 6. Implement Zhipu AI GLM Provider
  - [x] 6.1 Create providers/glm/provider.go with GLMProvider struct
    - Implement NewGLMProvider constructor with default BaseURL "https://open.bigmodel.cn/api/paas/v4"
    - Initialize HTTP client and RewriterChain
    - _Requirements: 2.1, 2.2_
  
  - [x] 6.2 Implement Provider interface methods
  ...
  - [x] 6.3 Implement Completion() and Stream() methods
  ...
  - [x] 6.4 Write property test for GLM error mapping
    - **Property 12: HTTP Status to Error Code Mapping**
    - **Validates: Requirements 2.8, 9.1-9.8**

- [x] 7. Implement MiniMax Provider (Custom Format)
  - [x] 7.1 Create providers/minimax/provider.go with MiniMaxProvider struct
  ...
  - [x] 7.2 Implement message and tool conversion functions
  ...
  - [x] 7.3 Implement tool call parsing function
  ...
  - [x] 7.4 Implement Provider interface methods
  ...
  - [x] 7.5 Implement Completion() method
    - Apply RewriterChain and handle credential override
  ...
  - [x] 7.7 Write property test for MiniMax tool call parsing
    - **Property 19: Tool Call Response Parsing**
    - **Validates: Requirements 3.8, 11.3**
  
  - [x] 7.8 Write unit test for XML tool call format
    - Test parseMiniMaxToolCalls() with various XML inputs
    - Test single and multiple tool calls
    - Test malformed XML handling
    - _Requirements: 11.3_

- [x] 8. Checkpoint - Verify all providers are implemented
  - Ensure all five providers compile and basic tests pass
  - Ask the user if questions arise

- [x] 9. Implement shared utility functions
  - [x] 9.1 Create or update error mapping function
  ...
  - [x] 9.2 Create model selection helper function
    - Implement chooseModel(requestModel, configModel, defaultModel) function
    - Test priority: request > config > default
    - _Requirements: 14.1, 14.2, 14.3_
  
  - [x] 9.3 Write property test for error mapping
    - **Property 12: HTTP Status to Error Code Mapping**
    - **Validates: Requirements 9.1-9.8**

- [x] 10. Implement RewriterChain integration
  - [x] 10.1 Write property test for RewriterChain application
    - **Property 8: RewriterChain Application**
    - **Validates: Requirements 7.1, 7.4**
  
  - [x] 10.2 Write property test for RewriterChain error handling
...
- [ ] 11. Implement tool calling support tests
  ...
  - [x] 11.2 Write property test for tool choice preservation
