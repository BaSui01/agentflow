...
// =============================================================================
// HandlePlanAgent with resolver — success
// =============================================================================

func TestAgentHandler_HandlePlanAgent_WithResolver_Success(t *testing.T) {
	reg := newMockRegistry().
	...
	ma := &mockAgent{
		planFn: func(ctx context.Context, input *agent.Input) (*agent.PlanResult, error) {
			return &agent.PlanResult{
				Steps: []string{"analyze", "execute", "report"},
			}, nil
		},
	}
...
// =============================================================================
// HandlePlanAgent with resolver — plan error
// =============================================================================

func TestAgentHandler_HandlePlanAgent_WithResolver_Error(t *testing.T) {
	reg := newMockRegistry()
...
// =============================================================================
// HandlePlanAgent with resolver — resolver not found
// =============================================================================

func TestAgentHandler_HandlePlanAgent_WithResolver_NotFound(t *testing.T) {
	reg := newMockRegistry()
